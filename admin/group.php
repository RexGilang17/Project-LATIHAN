...
<body class = "alert-warning">
	...
	<div class = "container-fluid">
		<ul class="nav nav-pills">
			<li><a href="home.php">Biodata Guru</a></li>
			<li><a href="account.php">Account</a></li>
			<li><a href="member.php">Data Siswa</a></li>
			<li ><a href="club.php">Mata Pelajaran</a></li>
			<li ><a href="#">Jadwal Pelajaran</a></li>
            <li ><a href="club.php">Harga Pendaftaran</a></li>
		</ul>
		<br />
		<div class = "col-md-12 well">
			<button type = "button" class = "btn btn-success"  data-toggle="modal" data-target="#myModal"><span class = "glyphicon glyphicon-plus"></span> Add Siswa</button>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Mata Pelajaran Registration</h4>
			</div>
...
<footer class = "navbar navbar-fixed-bottom navbar-inverse">
		<label class = "pull-right">&copy; <?php echo date('Y', strtotime('+8 HOURS'))?> GILANG ROMADHAN</label>
	</footer>
</body>	
