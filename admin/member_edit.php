...
<body class = "alert-warning">
	...
	<div class = "container-fluid">
		<ul class="nav nav-pills">
			...
			<li class="active"><a href="member.php">Data Siswa</a></li>
			...
			<div class = "row">	
				...
				<div class = "col-md-4">
					...
					<form method = "POST">
						...
						<div class = "form-group">
							<label>Class</label>
							<input type = "text" id = "class" type = "text" value= "<?php echo $acc_fetch['class']?>" class = "form-control" />
						</div>
						<div class = "form-group">
							<label>AsalSekolah</label>
							<input type = "text" id = "class" type = "text" value= "<?php echo $acc_fetch['asalsekolah']?>" class = "form-control" />
						</div>
						<div id = "loading">
						</div>
						<br />
